...
email = driver.find_element(By.XPATH, "//input[contains(@placeholder,'name@example.com')]")
email.send_keys("matyzock@gmail.com")
time.sleep(1)

direccion = driver.find_element(By.XPATH, "//textarea[@id='currentAddress']")
direccion.send_keys("Calle 113")
time.sleep(1)

direccion1 = driver.find_element(By.XPATH, "//textarea[@id='permanentAddress']")
